...
export default function Hero() {
  return (
    <div className='bg-sky-50 w-full h-auto flex flex-col items-center justify-center p-28 text-center'>
        <div className="flex flex-col justify-center items-center gap-8">
            ...
            <h1 className="flex flex-col text-gray-700 items-center text-3xl md:text-5xl border-b-2 border-slate-300 pb-8">
                Menos conversinha,
                <span className='text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-sky-600 font-bold text-5xl md:text-7xl'>Mais conversão</span>
            </h1>
